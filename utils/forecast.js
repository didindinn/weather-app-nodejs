  ...
  request({ url: URL, json: true }, (error, response) => {
    ...
    if (error) {
      ...
      return callback(
        ...
        `${data.daily.data[0].summary}  بیشترین دما: ${data.daily.data[0].temperatureHigh}درجه سانتی گراد میباشد.`
        `${data.daily.data[0].summary} کمترین دما: ${data.daily.data[0].temperatureLow}درجه سانتی گراد میباشد.`
        `${data.daily.data[0].summary} شانس بارندگی امروز شما ${data.currently.precipProbability}% می باشد.`
      );
    }
  });
};
